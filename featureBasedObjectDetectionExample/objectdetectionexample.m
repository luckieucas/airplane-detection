...
sceneImage = imread('airplane38.tif');
sceneImage= im2single(sceneImage) ;
if size(sceneImage,3) > 1, sceneImage = rgb2gray(sceneImage) ; else sceneImage= sceneImage ; end
...
elephantImage = imread('plane2.jpg');
elephantImage= im2single(elephantImage) ;
if size(elephantImage,3) > 1, elephantImage= rgb2gray(elephantImage) ; else elephantImage=elephantImage; end
...
line(newElephantPolygon(:, 1), newElephantPolygon(:, 2), 'Color', 'r');
